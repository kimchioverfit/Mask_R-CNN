...
class ConvertCocoPolysToMask:
    def __call__(self, image, target):
        ...
        out["area"] = torch.tensor([obj["area"] for obj in anno])
        out["iscrowd"] = torch.tensor([obj["iscrowd"] for obj in anno])
...
def convert_to_coco_api(ds):
    ...
    # annotation IDs need to start at 1 (torchvision issue #1530)
    ann_id = 1
...
def get_coco_api_from_dataset(dataset):
    # NOTE: originally tried to unwrap CocoDetection/Subsets; now always convert
